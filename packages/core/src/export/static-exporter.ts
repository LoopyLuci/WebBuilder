// ============================================================================
// Static Exporter — Static HTML/CSS/JS
// Generates a complete static website with no build step required
// ============================================================================
...
export class StaticExporter extends BaseExporter {
  readonly id = 'static' as const;
  readonly name = 'Static';
  readonly description = 'Static HTML/CSS/JS website (no build step)';
  ...
  exportSync(options: ExportOptions): ExportResult {
    ...
    // Generate assets directory placeholder
    files.push(this.createFile('assets/.gitkeep', ''));
    ...
    if (includeReadme) {
      files.push(this.createFile('README.md', this.generateReadme(spec, 'Static HTML/CSS/JS', this.getScripts())));
    }
