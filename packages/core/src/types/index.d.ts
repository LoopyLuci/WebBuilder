...
export type ConstraintType = 'budget' | 'timeline' | 'tech-stack' | 'accessibility' | 'performance' | 'security' | 'seo' | 'browser-support' | 'custom';
...
export type ComponentCategory = 'layout' | 'navigation' | 'form' | 'display' | 'feedback' | 'data' | 'interactive' | 'media' | 'composite' | 'template' | 'page';
