...
export class ContentGenerator {
    ...
    detectIndustry(spec) {
        ...
        if (text.includes('saas') || text.includes('platform') || text.includes('tool') || text.includes('dashboard'))
            return 'saas';
        if (text.includes('shop') || text.includes('store') || text.includes('ecommerce') || text.includes('e-commerce') || text.includes('sell'))
            return 'ecommerce';
        if (text.includes('portfolio') || text.includes('design') || text.includes('creative') || text.includes('agency'))
            return 'portfolio';
        if (text.includes('blog') || text.includes('article') || text.includes('content') || text.includes('news'))
            return 'blog';
        return 'default';
    }
    generate() {
