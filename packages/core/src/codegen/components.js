...
export class ComponentCodeGenerator {
     ...
     */
    getComponentTemplate(name, section) {
...
`;
     ...
     */
    generateActivityFeed(name, props) {
        return `'use client';
...
`;
     ...
     */
    generateTestimonials(name, props) {
        return `'use client';
...
export function generateComponents(spec) {
