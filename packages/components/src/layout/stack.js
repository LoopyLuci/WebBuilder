...
export const Stack = React.forwardRef(({ direction = 'vertical', spacing = 'md', align, justify, wrap = false, dividers = false, reverse = false, children, className = '', ...props }, ref) => {
    const spacingClass = direction === 'horizontal'
