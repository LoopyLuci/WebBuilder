...
export declare class RealtimeError extends Error {
    code: 'CONNECTION_ERROR' | 'AUTH_FAILED' | 'ROOM_NOT_FOUND' | 'RATE_LIMITED' | 'INVALID_EVENT';
    constructor(message: string, code: 'CONNECTION_ERROR' | 'AUTH_FAILED' | 'ROOM_NOT_FOUND' | 'RATE_LIMITED' | 'INVALID_EVENT');
}
