...
export declare class DatabaseError extends Error {
    code: 'CONNECTION_ERROR' | 'QUERY_ERROR' | 'NOT_FOUND' | 'VALIDATION_ERROR' | 'CONSTRAINT_VIOLATION';
    constructor(message: string, code: 'CONNECTION_ERROR' | 'QUERY_ERROR' | 'NOT_FOUND' | 'VALIDATION_ERROR' | 'CONSTRAINT_VIOLATION');
}
