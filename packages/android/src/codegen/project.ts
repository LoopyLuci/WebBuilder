...
export class AndroidProjectGenerator {
  private config: AndroidProjectConfig;
   ...
   */
  private generateSettingsGradle(): AndroidFileChange {
    return {
...
`,
   ...
   */
  private generateProjectGradle(): AndroidFileChange {
    return {
...
`,
   ...
   */
  private generateAppGradle(): AndroidFileChange {
...
`,
   ...
   */
  private generateGradleProperties(): AndroidFileChange {
    return {
...
`,
   ...
   */
  private generateLibsVersions(): AndroidFileChange {
    return {
...
`,
   ...
   */
  private generateManifest(): AndroidFileChange {
...
`,
   ...
   */
  private generateActivityManifest(activity: AndroidActivityConfig): string {
...
${launcher}
   ...
   */
  private generateKotlinFiles(): AndroidFileChange[] {
    const files: AndroidFileChange[] = [];
   ...
   */
  private generateComposeActivity(activity: AndroidActivityConfig): AndroidFileChange {
...
`,
   ...
   */
  private generateTraditionalActivity(activity: AndroidActivityConfig): AndroidFileChange {
    const packagePath = this.config.packageName.replace(/\./g, '/');
...
`,
   ...
   */
  private generateDefaultComposable(activity: AndroidActivityConfig): string {
   ...
   */
  private generateComposable(name: string): string {
    return `@Composable
fun ${name}() {
    // TODO: Implement ${name}
}`;
   ...
   */
  private generateResources(): AndroidFileChange[] {
    const files: AndroidFileChange[] = [];
...
`,
   ...
   */
  private getGradleConfig(): GradleConfig {
    return {
   ...
   */
  private getManifest(): AndroidManifest {
    return {
   ...
   */
  private toLibAlias(dep: string): string {
    return dep.replace(/[:.-]/g, '_').replace(/_+/g, '_');
  }
}

export function generateAndroidProject(config: AndroidProjectConfig): GeneratedAndroidProject {
