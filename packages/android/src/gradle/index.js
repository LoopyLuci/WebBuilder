 ...
 */
export function generateGradleWrapperScript() {
    return [
        '#!/bin/sh',
        '',
 ...
 */
export function generateGradleWrapperScriptWindows() {
    return [
        '@echo off',
        'setlocal',
        'set DIRNAME=%~dp0',
 ...
 */
export function getCommonGradleTasks() {
    return [
 ...
 * Run a Gradle task
 */
export async function runGradleTask(projectPath, task, args = []) {
 ...
 * Build the debug APK
 */
export async function buildDebugApk(projectPath) {
    return runGradleTask(projectPath, 'assembleDebug');
}
/**
 * Build the release APK
 */
export async function buildReleaseApk(projectPath) {
    return runGradleTask(projectPath, 'assembleRelease');
}
/**
 * Install and run the debug APK on the emulator
 */
export async function installAndRun(projectPath) {
