...
import { generateAndroidComponents, androidComponents, getAllAndroidComponentIds, } from '../../dist/index.js';
...
describe('generateAndroidComponents', () => {
    ...
    it('should create correct file paths for components', () => {
        ...
        expect(scaffoldFile.path).toBe('app/src/main/java/com/example/myapp/ui/components/Scaffold.kt');
        ...
        expect(cardFile.path).toBe('app/src/main/java/com/example/myapp/ui/components/Card.kt');
    });
    ...
    it('should handle invalid component IDs gracefully', () => {
        ...
        const buttonFile = result.find((f) => f.path.includes('Button.kt'));
        expect(buttonFile).toBeDefined();
        const nonexistentFile = result.find((f) => f.path.includes('nonexistent-component'));
    ...
    it('should preserve package path dots in file paths', () => {
        ...
        expect(fabFile.path).toBe('app/src/main/java/com/company/product/app/ui/components/FloatingActionButton.kt');
    });
});
